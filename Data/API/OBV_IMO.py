...
url = f'https://www.alphavantage.co/query?function=OBV&symbol=IMO.TO&interval=daily&apikey={api_key}'
r = requests.get(url)
...
output_file = os.path.join(project_directory, "CSV", "OBV_IMO.csv")
