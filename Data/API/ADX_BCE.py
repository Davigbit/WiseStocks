...
url = f'https://www.alphavantage.co/query?function=ADX&symbol=BCE.TO&interval=daily&time_period=14&apikey={api_key}'
r = requests.get(url)
...
output_file = os.path.join(project_directory, "CSV", "ADX_BCE.csv")
