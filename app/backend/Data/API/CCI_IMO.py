...
url = f'https://www.alphavantage.co/query?function=CCI&symbol=IMO.TO&interval=daily&time_period=10&apikey={api_key}'
r = requests.get(url)
...
output_file = os.path.join(project_directory, "CSV", "CCI_IMO.csv")
