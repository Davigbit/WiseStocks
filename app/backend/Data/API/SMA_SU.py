...
url = f'https://www.alphavantage.co/query?function=SMA&symbol=SU.TO&interval=daily&time_period=10&series_type=open&apikey={api_key}'
r = requests.get(url)
...
output_file = os.path.join(project_directory, "CSV", "SMA_SU.csv")
